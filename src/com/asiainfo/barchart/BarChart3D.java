...
public class BarChart3D {
	public static void main(String[] args) throws IOException {
		...
		// 创建图表
		JFreeChart jFreeChart = ChartFactory.createBarChart3D("BBA 1-3月份销量", // 图表标题
				"月份", // 横轴名称
				"销量", // 纵轴名称
				categoryDataset, // 数据集
		...
		// 导出图片
		OutputStream os = new FileOutputStream("/Users/zhangzhiwang/Pictures/JFreeChart/三维柱状图.png");
